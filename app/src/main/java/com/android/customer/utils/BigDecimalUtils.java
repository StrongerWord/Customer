package com.android.customer.utils;
...
public class BigDecimalUtils {
     ...
     * @return 两个参数的和
     */
    public static double add(double v1, String v2, int scale) {
        if (scale < 0) {
    ...
    public static double randomPrice() {
        double value = ThreadLocalRandom.current().nextDouble(2, 10);
        return new BigDecimal(value).setScale(2, ROUND_HALF_DOWN).doubleValue();
    }
